...
test("Content Inbox 提供上下文感知收件箱、关注作者和素材库 Side Panel", () => {
  ...
  assert.match(script, /data-action="asset-view-cover"/u);
  ...
  assert.match(script, /asset-image-backdrop/u);
  assert.match(script, /asset-image-close/u);
  ...
  assert.match(css, /\.asset-image-backdrop/u);
